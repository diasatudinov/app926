                    ...
                    Button {
                        if !name.isEmpty, let grade = Double(grade) {
                            if let image = selectedImage {
                                let desert = Dessert(imageData: image.jpegData(compressionQuality: 1.0), name: name, grade: grade, notes: notes)
                                viewModel.createNewDessert(desert)
                            } else {
                                let desert = Dessert(name: name, grade: grade, notes: notes)
                                viewModel.createNewDessert(desert)
                            }
                           createDesertShow = false
                        }
